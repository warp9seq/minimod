#!/usr/bin/env bash
#
# Usage: ./compare_view_mk_bed_mm_tsv.sh file1.bedmethyl file2.tsv output_dir
#
...
f2="$2"
out_dir=$3
# Check if extension of files are correct. file1 should be .bed or .bedmethyl and file2 should be .tsv
if [[ "$f1" != *.bed  && "$f1" != *.bedmethyl ]] || [[ "$f2" != *.tsv ]]; then
    echo "Error: file1 should have .bed or .bedmethyl extension and file2 should have .tsv extension."
    exit 1
fi
