...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -r test/tmp/genome_chr22.fa -t 8 test/data/example-hifi.bam > test/tmp/test3.tsv  || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -b -r test/tmp/genome_chr22.fa -t 8 test/data/example-hifi.bam > test/tmp/test4.bedmethyl  || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -r test/tmp/genome_chr22.fa -t 8 test/data/example-ont.bam > test/tmp/test5.tsv || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -b -r test/tmp/genome_chr22.fa -t 8 test/data/example-ont.bam > test/tmp/test6.bedmethyl || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -r test/tmp/genome_chr22.fa -m 0.2 -t 8 test/data/example-ont.bam > test/tmp/test7.tsv || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -c "mh" -r test/tmp/genome_chr22.fa -t 8 test/data/example-ont.bam > test/tmp/test8.tsv || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -c "h" -r test/tmp/genome_chr22.fa -t 8 test/data/example-ont.bam > test/tmp/test9.tsv || die "${testname} Running the tool failed"
...
echo -e "${BLUE}${testname}${NC}"
ex  ./minimod mod-freq -c "mh" -m "0.2,0.5" -r test/tmp/genome_chr22.fa -t 8 test/data/example-ont.bam > test/tmp/test12.tsv || die "${testname} Running the tool failed"
...
# echo -e "${BLUE}${testname}${NC}"
# # ex  ./minimod mod-freq -r $ref -t 32 reads.bam > test/tmp/ext.test2.tsv || die "${testname} Running the tool failed"
