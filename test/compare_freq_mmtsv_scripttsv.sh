#!/usr/bin/env bash
#
# Usage: ./compare_freq_mmtsv_scripttsv.sh file1.tsv file2.tsv output_dir
#
...
f2=$2
out_dir=$3
# Check if extension of files are correct. file1 should be .tsv and file2 should be .tsv
if [[ "$f1" != *.tsv ]] || [[ "$f2" != *.tsv ]]; then
    echo "Error: Both file1 and file2 should have .tsv extension."
    exit 1
fi
