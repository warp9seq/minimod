#!/usr/bin/env bash
#
# Usage: ./compare_freq_mmbed_scripttsv.sh file1.bed file2.tsv output_dir
#
...
f2=$2
out_dir=$3
# Check if extension of files are correct. file1 should be .bed and file2 should be .tsv
if [[ "$f1" != *.bed ]] || [[ "$f2" != *.tsv ]]; then
    echo "Error: file1 should have .bed extension and file2 should have .tsv extension."
    exit 1
fi
